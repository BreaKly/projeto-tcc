...
try {
        ...
        if($tccPDO->execute()) {
            echo 
                ...
                <div class='p-2'>
                </p style='font-size: 18px;'>Foi feito o cadastro do TCC com sucesso. Voltando automaticamente.</p>
            ...
            echo 
                ...
                <a href='../../../frontend/addTcc.php' class='btn btn-outline-primary m-2'>HOME</a>";
        }
