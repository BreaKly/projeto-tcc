    ...
    <div class="d-flex vh-100">
        ...
        <div class='w-50 d-flex justify-content-center align-items-center'>
            <form enctype='multipart/form-data' action='../backend/action/inserir.php' method='post' class='w-75'>
                ...
                <div class='form-div form-floating mb-3'>
                    <input type='email' class='form-control' id='natureza' name='natureza' placeholder='Natureza' required>
                    <label for='natureza'>Natureza</label>
                </div>
                <div class='form-div form-floating mb-3'>
                    <input type='password' class='form-control' id='autPrinc' name='autPrinc' placeholder='Autor principal' required>
                    <label for='autPrinc'>Autor principal</label>
                </div>
                <div class='form-div form-floating mb-3'>
                    <input type='password' class='form-control' id='emailAutPrinc' name='emailAutPrinc' placeholder='Email do autor principal' required>
