            ...
            echo "<div class='p-2 table-responsive'>
                    ...
                    foreach($modeloArtigo as $item){
                        echo "<tr>
                                ...
                                <td class='text-center'><a href='../backend/action/deletar.php?codArtigo={$item->getCodArtigo()}' class='btn btn-danger'>Apagar</a></td>
                        </tr>";
                    }   
            echo "</table>
                </div>";
            echo "<div class='p-2 table-responsive'>
                    ...
                    foreach($modeloCoAutor as $item){                      
                        echo "<tr>
                                ...
                                <td class='text-center'><a href='../backend/action/deletar.php?codArtig={$item->getCodArtig()}' class='btn btn-danger'>Apagar</a></td>
                        </tr>";
                    }
            echo "</table>
                </div>";
            echo "<div class='p-2 table-responsive'>
                    ...
                    foreach($modeloProjeto as $item){
                        echo "<tr>                
                            ...
                            <td class='text-center'><a href='../backend/action/deletar.php?userNome={$item->getCodProj()}' class='btn btn-danger'>Apagar</a></td>
                        </tr>";
                    }
            echo "</table>
                </div>";
            echo "<div class='p-2 table-responsive'>
                    ...
                    foreach($modeloResponsavel as $item){
                        echo "<tr>               
                            ...
                            <td class='text-center'><a href='../backend/action/deletar.php?userNome={$item->getNome()}' class='btn btn-danger'>Apagar</a></td>
                        </tr>";
                    }
            echo "</table>
                </div>";
            echo "<div class='p-2 table-responsive'>
                    ...
                    foreach($modeloTcc as $item){
                        echo "<tr>
                            ...
                            <td class='text-center'><a href='../backend/action/deletar.php?codProj={$item->getCodProj()}' class='btn btn-danger'>Apagar</a></td>
                        </tr>";
                    }
            echo "</table>
            </div>";
